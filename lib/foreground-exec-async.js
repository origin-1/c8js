...
function validateKillSignal(killSignal)
{
    ...
    {
        const message = 'The value of "killSignal" must be one of type string or number.';
...
function validateMaxBuffer(maxBuffer)
{
    ...
    {
        const message =
        'The value of "maxBuffer" is out of range. It must be a non-negative number.';
...
function validateTimeout(timeout)
{
    ...
    {
        const message = 'The value of "timeout" is out of range. It must be an unsigned integer.';
        const error = RangeError(message);
        error.code = 'ERR_OUT_OF_RANGE';
        throw error;
    }
